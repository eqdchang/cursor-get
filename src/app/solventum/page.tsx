...
import { SiteFooter } from "../../../bundles/sites/solventum/src/footer/SiteFooter";
import { SiteHeader } from "../../../bundles/sites/solventum/src/header/SiteHeader";
      ...
      <main className="pt-10 pb-24">
        <div className="max-w-3xl mx-auto px-6 text-gray-700 leading-relaxed">
          <h1 className="text-3xl font-semibold text-gray-900 mb-6">
            Solventum — header + footer preview
          </h1>
          <p className="mb-4">
            Rendering{" "}
            <code className="px-1.5 py-0.5 bg-gray-100 rounded text-sm">
              bundles/sites/solventum/src/
            </code>{" "}
          ...
          <p>
            To ship:{" "}
            <code>cd bundles &amp;&amp; npm run build:solventum</code> &rarr;
            drop <code>dist/solventum/header.bundle.js</code> and{" "}
            <code>dist/solventum/footer.bundle.js</code> into any host site
