# SiteHeader Specification (v2 — hover-reveal dropdowns + real links)

## Overview
- **Target file:** `src/components/sections/SiteHeader.tsx`
- **Source of truth:** live DOM of `https://boardwalktech.com/` extracted via Playwright on 2026-04-21
- **Interaction model:** mixed — plain anchors for top-level links, **hover-revealed dropdown** per nav group on desktop, **click-to-toggle drawer** on mobile
- **Client component?** yes (mobile drawer state + aria-expanded)
