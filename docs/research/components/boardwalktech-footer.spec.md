# SiteFooter Specification (v2 — real links)

## Overview
- **Target file:** `src/components/sections/SiteFooter.tsx`
- **Source of truth:** live DOM of `https://boardwalktech.com/` extracted via Playwright on 2026-04-21
- **Interaction model:** static — all anchors point to real boardwalktech.com subpaths. Investors opens in a new tab.
