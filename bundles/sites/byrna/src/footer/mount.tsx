...
const DEFAULT_MOUNT_ID = "byrna-footer-root";
...
function mount(target?: MountTarget): void {
  ...
  if (!el) {
    console.warn(
      `[ByrnaFooter] mount target not found. Pass a selector or Element, or add <div id="${DEFAULT_MOUNT_ID}">.`,
    );
    return;
  }
  if (activeRoot) {
...
if (typeof window !== "undefined") {
  (window as unknown as { ByrnaFooter: typeof api }).ByrnaFooter = api;
