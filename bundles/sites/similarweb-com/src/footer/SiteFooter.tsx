...
const COL_A_TOP: FooterSection = {
  ...
  links: [
    ...
    { label: "Top Browsers", href: "/browsers/" },
      ...
      <footer className="bg-[#000921] text-white/60">
        <div className="mx-auto max-w-[1248px] px-6 pt-16 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[minmax(220px,300px)_1fr_1fr_1fr_1fr] gap-10 lg:gap-8">
            <div className="flex flex-col gap-6">
              ...
              <A
                ...
                external
                className="text-[14px] font-normal text-white/60 hover:text-white transition-colors leading-relaxed"
              >
          ...
          <div className="mt-16 pt-8 border-t border-white/10">
            <A
              href="/corp/about/"
              className="text-white text-[16px] font-medium hover:text-white/80"
            >
          ...
          <div className="mt-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-6 flex-wrap">
              <button
                type="button"
                className="inline-flex items-center gap-1.5 text-[14px] font-normal text-white/60 hover:text-white"
                aria-haspopup="menu"
                aria-expanded="false"
              >
                English
