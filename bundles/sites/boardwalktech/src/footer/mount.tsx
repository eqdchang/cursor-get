...
const DEFAULT_MOUNT_ID = "boardwalk-footer-root";
...
function mount(target?: MountTarget): void {
  ...
  if (!el) {
    console.warn(
      `[BoardwalkFooter] mount target not found. Pass a selector or Element, or add <div id="${DEFAULT_MOUNT_ID}">.`,
    );
    return;
  }
  if (activeRoot) {
...
if (typeof window !== "undefined") {
  (window as unknown as { BoardwalkFooter: typeof api }).BoardwalkFooter = api;
