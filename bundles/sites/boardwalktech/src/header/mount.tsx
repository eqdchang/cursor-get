...
const DEFAULT_MOUNT_ID = "boardwalk-header-root";
...
function mount(target?: MountTarget): void {
  ...
  if (!el) {
    console.warn(
      `[BoardwalkHeader] mount target not found. Pass a selector or Element, or add <div id="${DEFAULT_MOUNT_ID}">.`,
    );
    return;
  }
  if (activeRoot) {
...
if (typeof window !== "undefined") {
  (window as unknown as { BoardwalkHeader: typeof api }).BoardwalkHeader = api;
